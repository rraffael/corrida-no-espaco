...
## Data the game collects directly

**None.** The game does not ask for your name, e-mail, phone number, location, contacts,
photos, microphone or camera. There is no account system and no server to send anything to.
...
Distribution through Google Play means Google collects installation data, store usage data and,
when the app crashes, error reports. This is done by the platform, not by the game, and the
developer only has access to **aggregated, anonymous statistics** in the Play Console — never to
data about an identified person.

## Ads and purchases

This version contains **no ads and no in-app purchases**. If that changes, this policy will be
updated **before** the corresponding version is released, naming the advertising partner and the
data it processes.

## Children

The game is **not directed to children under 13** and does not knowingly collect data from
children. If you are a parent or guardian and believe a child has provided personal data through
the game, please write to the contact e-mail: any such data will be deleted.

## Your rights

Because the game collects no personal data, there is nothing to request, correct or delete from
...
Since the game neither collects nor transmits personal data, there is no user database that
could leak. Local data is protected by Android's own app sandboxing.
...
*Versão em português: [politica-de-privacidade.md](politica-de-privacidade.md)*
